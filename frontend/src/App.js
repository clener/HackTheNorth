...
class App extends Component {
  ...
  showAndroidRender(){
    this.setState({showAndroid: true});
  }
  ...
  render() {
    ...
    var toRender = (<IssueList issues={this.state.data} socket={this.socket} showAndroidRender={() => this.showAndroidRender()}/>);

    if (this.state.showAndroid){
        toRender = (<AndroidRenderer socket={this.socket}/>);
    }
